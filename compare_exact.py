...
print(primer_sets['1']['F1'] == primer_sets['1S']['F1'])
print("F1 (1) :", primer_sets['1']['F1'])
print("F1 (1S):", primer_sets['1S']['F1'])
print(primer_sets['1']['F2'] == primer_sets['1S']['F2'])
print("F2 (1) :", primer_sets['1']['F2'])
print("F2 (1S):", primer_sets['1S']['F2'])
